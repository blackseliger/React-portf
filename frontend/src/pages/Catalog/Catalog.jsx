            ...
            <section className="catalog">
                    ...
                    <ul className="catalog-categories nav justify-content-center">
                        <li className="nav-item">
                            ...
                            {/* было <Link className='nav-link active' to='/'>Все</Link>  Учесть изменение класса!!!*/}
                        </li>
                        <li className="nav-item">
                        ...
                        <div className="col-4">
                            <div className="card catalog-item-card">
                                ...
                                <div className="card-body">
                                    ...
                                    <Link className='btn btn-outline-primary' to='/'>Заказать</Link>
                                    {/* Поправить ссылки в будущем!! */}
