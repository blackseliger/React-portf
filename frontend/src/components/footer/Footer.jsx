...
export default function Footer() {
    return (
            ...
            <div class="col">
                <section>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item"><Link className='nav-link' to='/about'>О магазине</Link></li>
                        <li class="nav-item"><Link className='nav-link' to='/catalog'>Каталог</Link></li>
                        <li class="nav-item"><Link className='nav-link' to='/contacts'>Контакты</Link></li>
                    </ul>
                </section>
            </div>
            <div class="col">
                <section>
                    ...
                    {/* Снова опечатка в закрывающием теге? было /h3   */}
        ...
        {/* убрал лишний закрывающий div, опечатка? */}
    </footer>  
    )
}